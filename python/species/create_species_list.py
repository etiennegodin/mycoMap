...
import pandas as pd
#data/input/table/species_list.csv

# Create and save file listing species info for gbif 
...
if __name__ == '__main__':
    ...
    species_dict_list = create_species_list('data/input/table/species.csv')
    write_species_list(species_dict_list, 'data/input/table/species_list.csv')